...
describe('Controller: ForgotPasswordCtrl', function () {
  ...
  it('should submit the form and return error for trying to reset "admin@mnrt.go.tz"', function () {
    createController()

    scope.userEmail = 'admin@mnrt.go.tz'
    scope.submitRequest()

    scope.alerts.should.have.property('forgotPassword')
    scope.alerts.forgotPassword[0].should.have.property('type', 'danger')
    scope.alerts.forgotPassword[0].should.have.property('msg', 'Cannot reset password for "admin@mnrt.go.tz"')
  })
